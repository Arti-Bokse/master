...
@Component({
  selector: 'app-studymaterial-detail',
  templateUrl:'./studymaterial.detail.component.html',
  styleUrls: ['./studymaterial.detail.component.css']
})

export class StudyMaterialDetailComponent implements OnInit {
  studymaterials: any[]
