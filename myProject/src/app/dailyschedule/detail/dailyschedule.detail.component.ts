...
@Component({
  selector: 'app-dailyschedule-detail',
  templateUrl:'./dailyschedule.datail.component.html',
  styleUrls: ['./dailyschedule.detail.component.css']
})

export class DailyScheduleDetailComponent implements OnInit {
  dailyschedules: any[]
