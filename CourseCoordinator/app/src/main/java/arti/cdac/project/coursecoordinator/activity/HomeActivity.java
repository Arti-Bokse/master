...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv = (TextView)hView.findViewById(R.id.textName);
        TextView tv1 = (TextView)hView.findViewById(R.id.textEmail);
        tv.setText(intent.getStringExtra("name"));
        tv1.setText(intent.getStringExtra("email"));

        String url = Utils.getUrl("/" + intent.getStringExtra("pic"));
        Ion.with(this)
                .load(url)
                .withBitmap()
                .intoImageView(imgvw);
